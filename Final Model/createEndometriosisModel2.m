function m1 = createEndometriosisModel2(nva)
arguments
...
m1.addparameter('Kaff0', 'Value', 0.6*1000, 'Units','nanomolarity', ...
   'Constant', 0);
% m1.addparameter('KaffDelay', 'Value', 0, 'Units','nanomolarity', ...
%    'Constant', 0);
%ed.addspecies('KaffDelay',      'Value', 0,              'Units', 'nanomolarity');
m1.addparameter('Kaff', 'Value', 0, 'Units','nanomolarity', ...
   'Constant', 0);
...
% m1.addparameter('koutChOFF', 'Value', nva.kinChOFF, 'Units','1/hour', 'Constant', 0);%0.8 was arbitrarily picked to give a delay that would take hours to take that
 m1.addparameter('eps',   'Value', 1,              'Units','dimensionless');
%-------------------------------------------------------------
%  m1.addreaction('null  -> KaffDelay  ',...
%      'ReactionRate', 'kinChON * (NO/NO0 + EP3/EP30)^eps',...
%       'Name', 'Activation of Pump by EP3 and NO');
%  m1.addreaction('KaffDelay -> null', 'ReactionRate', 'koutChOFF*KaffDelay',...
%       'Name', 'Deactivation of Pump by EP3 and NO');
%-------------------------------------------------------------
addrule(m1, 'Kaff = Kaff0 * (NO/NO0 + EP3/EP30)^eps', 'RuleType', 'repeatedAssignment'); %get a delay to ensure impact in hours
%-------------------------------------------------------------
%-------------------------------------------------------------
%-------------------------------------------------------------
%-------------------------------------------------------------
...
m1.addparameter('ScaleCh', 'Value', 1, 'Units','1/(nanomolarity*nanomolarity)'); %reflect the kout in order of days
%-------------------------------------------------------------
...
%pain from flux
% ed.addspecies('PainFlux',      'Value', 0,              'Units', 'nanomolarity');
% m1.addparameter('kelpainFlux',   'Value', 1,              'Units','1/hour');
% m1.addreaction(' null  -> PainFlux  ', 'ReactionRate', 'JFlux',...
%     'Name', 'flux related pain');
% m1.addreaction('PainFlux -> null ', 'ReactionRate', 'kelpainFlux*PainFlux',...
%     'Name', 'removal of painflux');
 m1.addparameter('HPain', 'Value', 1, 'Units', 'dimensionless', ...
    'Constant', 0);
addrule(m1, 'PainScore = 1*JFlux^2/(JFlux^2 + PainThreshold^2)', 'RuleType', 'repeatedAssignment');
%--------------------------
